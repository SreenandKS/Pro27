...
function movingBob(){
  if(bob1.isTouching(bob2)){
    Matter.Body.applyForce(bob5.body,bob5.body.position,{x:500,y:-300});
  }
  if(bob5.isTouching(bob4)){
    Matter.Body.applyForce(bob5.body,{x:bob1.body.position.x,y:bob1.body.position.y},{x:-500,y:300});
  }
}